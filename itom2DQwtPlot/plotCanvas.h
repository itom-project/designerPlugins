...
class PlotCanvas : public ItomQwtPlot
{
    ...
    private:
        ...
        template <typename _Tp> void parseVolumeCutObj( const ito::DataObject* srcObj, const QVector<int>& start, const QSize& step, const QVector<int>& stepSizes=QVector<int>());
