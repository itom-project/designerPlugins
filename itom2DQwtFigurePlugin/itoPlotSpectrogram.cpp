...
class ItoPlotSpectrogram::PrivateData
{
public:
    PrivateData():
        data( NULL ),
    ...
    DataObjectRasterData *data; //this is important so we can adapt renderTile() for improved performance over the olde value() method
...
*/
ItoPlotSpectrogram::ItoPlotSpectrogram( const QString &title ):
...
//! Destructor
ItoPlotSpectrogram::~ItoPlotSpectrogram()
{
...
int ItoPlotSpectrogram::rtti() const
{
    return QwtPlotItem::Rtti_PlotSpectrogram;
}
...
*/
void ItoPlotSpectrogram::setDisplayMode( DisplayMode mode, bool on )
{
...
*/
bool ItoPlotSpectrogram::testDisplayMode( DisplayMode mode ) const
{
...
*/
void ItoPlotSpectrogram::setRenderThreadCount( uint numThreads )
{
...
*/
uint ItoPlotSpectrogram::renderThreadCount() const
{
...
*/
void ItoPlotSpectrogram::setColorMap( QwtColorMap *colorMap )
{
...
/*!
   ...
   \sa setColorMap()
*/
const QwtColorMap *ItoPlotSpectrogram::colorMap() const
{
...
*/
void ItoPlotSpectrogram::setDefaultContourPen( const QPen &pen )
{
...
*/
QPen ItoPlotSpectrogram::defaultContourPen() const
{
...
*/
QPen ItoPlotSpectrogram::contourPen( double level ) const
{
...
*/
void ItoPlotSpectrogram::setConrecFlag(
...
/*!
   ...
   \sa setConrecClag(), renderContourLines(),
       QwtRasterData::contourLines()
*/
bool ItoPlotSpectrogram::testConrecFlag(
...
*/
void ItoPlotSpectrogram::setContourLevels( const QList<double> &levels )
{
...
/*!
   ...
   \sa contourLevels(), renderContourLines(),
       QwtRasterData::contourLines()
*/
QList<double> ItoPlotSpectrogram::contourLevels() const
{
...
/*!
  ...
  \sa data()
*/
void ItoPlotSpectrogram::setData( DataObjectRasterData *data )
{
    if ( data != d_data->data )
    {
        delete d_data->data;
...
/*!
  ...
  \sa setData()
*/
const DataObjectRasterData *ItoPlotSpectrogram::data() const
{
    return d_data->data;
}
...
/*!
  ...
  \sa setData()
*/
QwtRasterData *ItoPlotSpectrogram::data()
{
    return d_data->data;
}
...
*/
QwtInterval ItoPlotSpectrogram::interval(Qt::Axis axis) const
{
    if ( d_data->data == NULL )
        return QwtInterval();
...
/*!
   ...
   \sa QwtPlotRasterItem::pixelHint(), QwtRasterData::pixelHint(), 
       render(), renderImage()
*/
QRectF ItoPlotSpectrogram::pixelHint( const QRectF &area ) const
{
    if ( d_data->data == NULL )
        return QRectF();
...
*/
QImage ItoPlotSpectrogram::renderImage(
    ...
    const QRectF &area, const QSize &imageSize ) const
{
	...
	if ((d_data->data->getDataObjWidth() == 0) || (d_data->data->getDataObjHeight() == 0))
		return QImage();
    ...
    for ( uint i = 0; i < numThreads; i++ )
    {
        ...
        else
        {
            futures += QtConcurrent::run(
                this, &ItoPlotSpectrogram::renderTile,
...
*/
void ItoPlotSpectrogram::renderTile(
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
...
*/
QSize ItoPlotSpectrogram::contourRasterSize( 
...
/*!
   ...
   \sa contourLevels(), setConrecFlag(),
       QwtRasterData::contourLines()
*/
QwtRasterData::ContourLines ItoPlotSpectrogram::renderContourLines(
...
*/
void ItoPlotSpectrogram::drawContourLines( QPainter *painter,
        const QwtScaleMap &xMap, const QwtScaleMap &yMap,
...
*/
void ItoPlotSpectrogram::draw( QPainter *painter,
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
