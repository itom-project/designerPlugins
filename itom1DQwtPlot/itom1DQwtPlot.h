...
class ITOM1DPLOT_EXPORT Itom1DQwtPlot : public ItomQwtDObjFigure
{
    ...
    Q_CLASSINFO("prop://xData", "DataObject representing the xData of the plot. Expected a two dimensional dataObject with a (n x m) or (1 x m) shape for an (n x m) source object with n < m. For n > m a shape of (n x 1) or (n x m) is expected.")
